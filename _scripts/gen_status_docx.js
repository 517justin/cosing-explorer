    ...
    children: [
      ...
      table(
        ...
        [
          ...
          ['5', '挖掘隱藏關聯', DONE, '90-Reports/associations_v2026.md — 六項分析'],
          ['6', 'Vault 生成', DONE, '2,827 物種 + 376 科 + 134 MOC = 3,340 筆記'],
          ['7', 'AI 問答層', TODO, '四層混合檢索工具組'],
        ],
      ),
      p(''),
      p([t('進度：', { bold: true }), t('8 個 Phase 中，7 個完成、1 個未開始。Phase 0–3 在兩份資料上各跑完一次，Phase 4–6 已在 2026 資料上完成。')]),
      p(''),
      ...
      h('Phase 4 — 外部化學層富集　✅ 完成', HeadingLevel.HEADING_2),
      table(
      ...
      h('Phase 5 — 挖掘隱藏關聯　✅ 完成', HeadingLevel.HEADING_2),
      p('六項跨面向分析全部完成，產出 associations_v2026.md（780 行），七項驗收全數通過。'),
      table(
        [{ label: '#', w: 500, align: AlignmentType.CENTER }, { label: '分析', w: 3000 }, { label: '結果', w: 5526 }],
        [
          ['1', '空白格推薦 ⭐', '299 個科有 gap 候選；Asteraceae 1,807 種、Fabaceae 1,751 種在 LOTUS 中有化合物但不在 COSING'],
          ['2', '法規盲點分析 ⭐', 'Pinaceae 31.3%、Rutaceae 25.1% 受限率最高；II/358 呋喃香豆素驅動 Rutaceae'],
          ['3', '趨同用途檢測', '跨科 Function 聚類：Skin Conditioning 橫跨 308 科，Antioxidant 橫跨 171 科'],
          ['4', '化學分類學一致性', 'Cucurbitaceae、Solanaceae、Theaceae 100% 家族一致性；前五鄰居全為同科'],
          ['5', '同物種部位比較', '同物種不同部位/製程的組合自動成組'],
          ['6', '成分集合 Jaccard 相似度', '2,017 對（J≥0.15 且 ≥5 共享），1,498 為跨科對；Eucalyptus dives × Lagarostrobos franklinii J=0.789'],
        ],
      ),

      h('Phase 6 — Vault 生成　✅ 完成', HeadingLevel.HEADING_2),
      p('3,340 則 Markdown 筆記，以 2026 全庫資料生成。重跑 16_gen_vault.py 只覆寫 AUTO 區塊，人工筆記區永不觸碰。'),
      table(
        [{ label: '目錄', w: 2200, mono: true }, { label: '筆數', w: 1200, align: AlignmentType.RIGHT },
         { label: '內容', w: 5626 }],
        [
          ['10-Species/', '2,827', '物種筆記：分類、INCI 名、部位、製程、用途、化合物數、法規'],
          ['20-Family/', '376', '科筆記：物種清單、用途分布、受限率、化合物概覽'],
          ['30-MOC/', '137', '用途 82 + 部位 27 + 製程 25 + 索引頁 3'],
        ],
      ),
      note('AUTO-START / AUTO-END 標記已驗證：重跑後人工區塊零變動。所有科筆記中的 wikilink 均指向實際存在的物種筆記（0 斷鏈）。'),
      ...
      table(
        ...
        [
          ['1', 'Phase 7：AI 問答層', '四層混合檢索工具組', '1–2 天'],
        ],
      ),
      p(''),
      ...
      table(
        ...
        [
          ...
          ['_scripts/15_associations.py', 'Phase 5 六項跨面向關聯分析'],
          ['_scripts/16_gen_vault.py', 'Phase 6 Vault 筆記生成（3,340 則）'],
          ...
          ['90-Reports/associations_v2026.md', 'Phase 5 關聯分析（780 行，六項分析 + 驗收）'],
          ['10-Species/', 'Phase 6 物種筆記（2,827 則）'],
          ['20-Family/', 'Phase 6 科筆記（376 則）'],
          ['30-MOC/', 'Phase 6 用途/部位/製程 MOC（137 則）'],
