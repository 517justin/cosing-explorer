...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      p(''),
      p([t('進度：', { bold: true }), t('8 個 Phase 中，3 個完成、5 個未開始。必做骨幹 Phase 0–2 已全部完成，可進入 Phase 3。')]),
      ...
      table(
        ...
        [
          ['1', 'Phase 3：部位與製程抽取（字典比對，不需 LLM）', 'plant_part / process 欄', '0.5 天'],
          ['2', 'Phase 4：LOTUS（物種→成分）與 PubChem（CAS→結構）富集', 'species_compounds.csv、cas_structures.csv', '1 天'],
          ['3', 'Phase 5：關聯分析（可與 2 平行）', '90-Reports/ 各項分析', '1.5–2 天'],
          ['4', 'Phase 6：Vault 筆記生成', '10-Species / 20-Family / 30-MOC', '1 天'],
          ['5', 'Phase 7：AI 問答層', '四層混合檢索工具組', '1–2 天'],
        ],
      ),
      p(''),
